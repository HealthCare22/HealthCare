...
public class ValidateFieldsRegistration {
	...
	private static final String NOME_REGEX = "^[a-z A-Z איטלעש]{2,255}$";
	private static final String SURNAME_REGEX ="^[a-z A-Z איטלעש]{2,255}$";
	private static final String PASSWORD_REGEX = "^(?=([^\\s])*[0-9])(?=([^\\s])*[a-zA-Z])([^\\s]){8,24}$";
	private static final String PROVINCIA_REGEX = "^[a-z A-Z איטלעש]{2,255}$";
	private static final String COMUNE_REGEX = "^[a-z A-Z ֳ \\p{M}]{2,255}$";
	private static final String INDIRIZZO_REGEX = "^[a-z A-Z 0-9 איטלעש ',.-]{2,255}$";
